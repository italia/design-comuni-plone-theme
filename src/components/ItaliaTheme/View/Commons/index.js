...
export const PageHeaderEventDates = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderEventDates'
  ),
);
export const PageHeaderPersona = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderPersona'
  ),
);
export const PageHeaderBando = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderBando'
  ),
);
export const PageHeaderNewsItem = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderNewsItem'
  ),
);
export const PageHeaderStatoServizio = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderStatoServizio'
  ),
);
export const PageHeaderLinkServizio = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderLinkServizio'
  ),
);
...
export const PageHeaderDocumento = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeader/PageHeaderDocumento'
  ),
);
...
export const SearchSectionForm = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/SearchSectionForm'
  ),
);
export const PageHeaderNav = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/PageHeaderNav'
  ),
);
...
export const TrasparenzaFields = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/TrasparenzaFields'
  ),
);
...
export const BandoDates = loadable(() =>
  import(
    /* webpackChunkName: "DCPTViewsCommons" */ 'design-comuni-plone-theme/components/ItaliaTheme/View/Commons/BandoDates'
  ),
);
