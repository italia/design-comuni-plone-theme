...
import ServizioProcedure from '../ServizioView/ServizioProcedure';
...
test('expect to render fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioProcedure content={mock_all_fields} />
      </MemoryRouter>
    </Provider>,
  );

  expect(
    screen.getAllByRole('heading', { name: /Procedure collegate all'esito/i }),
  ).toBeTruthy();
