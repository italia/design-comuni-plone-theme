...
import ServizioCorrelati from '../ServizioView/ServizioCorrelati';
...
test('expect to render fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioCorrelati content={mock_all_fields} />
      </MemoryRouter>
    </Provider>,
  );
  ...
  expect(
    screen.getByRole('link', { name: /Concessione degli impianti sportivi/i }),
  ).toBeInTheDocument();
