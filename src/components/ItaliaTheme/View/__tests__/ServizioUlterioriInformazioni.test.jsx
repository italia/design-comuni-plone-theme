...
import ServizioUlterioriInformazioni from '../ServizioView/ServizioUlterioriInformazioni';
...
const mock_all_fields = {
  ...
  settore_merceologico: "hi, i'm the problem",
...
const store = mockStore({
  ...
  search: {
    ...
    batching: {},
    subrequests: {
      'modulistica/servizi/visita-veterinaria-gratis/modulistica': {
        error: null,
        items: [
          {
            '@components': {
              actions: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@actions',
              },
              aliases: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@aliases',
              },
              breadcrumbs: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@breadcrumbs',
              },
              contextnavigation: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@contextnavigation',
              },
              navigation: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@navigation',
              },
              subsite: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@subsite',
              },
              types: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@types',
              },
              workflow: {
                '@id':
                  'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@workflow',
              },
            },
            '@id': '/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls',
            '@type': 'File',
            UID: 'e7930fe967084eea93cbe907db5abc16',
            allow_discussion: false,
            contributors: [],
            created: '2023-03-16T10:16:34+00:00',
            creators: ['admin'],
            description: 'Where I get older but just never wiser',
            design_italia_meta_type: 'File',
            effective: null,
            exclude_from_nav: false,
            expires: null,
            file: {
              ...
              download:
                'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica/rubrica.xls/@@download/file',
              filename: 'Rubrica.xls',
              size: 116736,
            },
            id: 'rubrica.xls',
            is_folderish: false,
            ...
            layout: 'file_view',
            lock: {},
            modified: '2023-03-16T10:16:34+00:00',
            next_item: {},
            parent: {
              '@id':
                'http://localhost:3000/servizi/visita-veterinaria-gratis/modulistica',
              ...
              Creator: 'admin',
              Date: '2023-03-16T10:16:34+00:00',
              Description: '',
              EffectiveDate: 'None',
              ExpirationDate: 'None',
              ModificationDate: '2023-03-16T10:16:34+00:00',
              Subject: [],
              Subject_bando: null,
              Title: 'Modulistica',
              Type: 'Pagina',
...
test('expect to render fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioUlterioriInformazioni content={mock_all_fields} />
      </MemoryRouter>
    </Provider>,
  );
  ...
  expect(
    screen.getAllByRole('heading', { name: /Ulteriori informazioni/i }),
  ).toBeTruthy();
  expect(screen.getByText(/pulled my trigger/i)).toBeInTheDocument();

  // codice dell'ente erogatore
  expect(
    screen.getAllByRole('heading', { name: /Codice dell'ente erogatore/i }),
  ).toBeTruthy();
  expect(screen.getByText(/It's me/i)).toBeInTheDocument();

  // settore merceologico
  expect(
    screen.getAllByRole('heading', { name: /Settore merceologico/i }),
  ).toBeTruthy();
  expect(screen.getByText(/hi, i'm the problem/i)).toBeInTheDocument();
});
