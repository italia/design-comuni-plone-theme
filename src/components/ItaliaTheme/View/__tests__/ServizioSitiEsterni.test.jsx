...
import ServizioSitiEsterni from '../ServizioView/ServizioSitiEsterni';
...
test('expect to render fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioSitiEsterni content={mock_all_fields} />
      </MemoryRouter>
    </Provider>,
  );

  expect(screen.getAllByRole('heading', { name: /Link utili/i })).toBeTruthy();
