...
import ServizioAChiSiRivolge from '../ServizioView/ServizioAChiSiRivolge';
...
test('expect to have all mandatory fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioAChiSiRivolge content={mock_mandatory} />
      </MemoryRouter>
    </Provider>,
  );
...
test('expect to render other fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioAChiSiRivolge content={mock_all_fields} />
      </MemoryRouter>
    </Provider>,
  );
