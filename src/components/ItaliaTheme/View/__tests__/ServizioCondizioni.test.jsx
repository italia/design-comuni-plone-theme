...
import ServizioCondizioni from '../ServizioView/ServizioCondizioni';
...
test('expect to render fields in page', async () => {
  render(
    <Provider store={store}>
      <MemoryRouter>
        <ServizioCondizioni content={mock_all_fields} />
      </MemoryRouter>
    </Provider>,
  );
  ...
  expect(
    screen.getByRole('link', { name: /Termini e condizioni di servizio/i }),
  ).toBeInTheDocument();
});
