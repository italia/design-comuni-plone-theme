...
const store = mockStore({
  ...
  content: {
    ...
    data: {
      ...
      lock: {
        created: '2023-03-15T13:40:16Z',
        creator: 'admin',
        creator_name: 'admin',
        creator_url: 'http://localhost:3000/author/admin',
        locked: true,
        name: 'plone.locking.stealable',
        stealable: true,
        time: 1678887616.7669857,
        timeout: 600,
        token:
          '0.2129759856508825-0.6068826229191266-00105A989226:1678887616.767',
      },
      modified: '2023-03-13T11:57:27+00:00',
      motivo_stato_servizio: {
        blocks: {
