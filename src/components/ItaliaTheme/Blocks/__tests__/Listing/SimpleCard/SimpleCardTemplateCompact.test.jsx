...
import SimpleCardTemplateCompact from '../../../Listing/SimpleCard/SimpleCardTemplateCompact';
...
const mock_fields = {
  ...
  path_filters: {
    0: '{label: "Caught in a landside", path: Array(1)}',
  },
  query: [],
  querystring: {
    b_size: 3,
...
test('View renders all fields', async () => {
  ...
  //mostra icona
  const icon = document.querySelectorAll('.icon-argument-container');
