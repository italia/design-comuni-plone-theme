...
import SquaresImageTemplate from '../../Listing/SquaresImageTemplate';
...
const mock_fields = {
  ...
  '@type': 'listing',
  block: '0fefac79-948f-4921-9848-628d642ff4ab',
  headlineTag: 'h2',
  hide_dates: false,
  query: [],
  querystring: {
...
test('View renders all fields', async () => {
  ...
  const cards = document.querySelectorAll('.listing-item.box');
