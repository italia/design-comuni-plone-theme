...
import SliderTemplate from '../../Listing/SliderTemplate';
...
const mock_fields = {
  ...
  '@type': 'listing',
  block: '8ac3a3b1-4b92-4d78-82e1-4dde89a5aea6',
  headlineTag: 'h2',
  hide_dates: false,
  query: [],
  querystring: {
  ...
  show_pointer_list: true,
  show_section: true,
  show_type: false,
  variation: 'simpleListTemplate',
...
test('View renders all fields', async () => {
    ...
    <Provider store={store}>
      <MemoryRouter>
        <SliderTemplate
          ...
          // slidesToShow={'1'}
          reactSlick={mock_fields.reactSlick}
        />
      </MemoryRouter>
    </Provider>,
  );
  ...
  // expect(list).toHaveClass('decoration-pointer');

  // //risultati per pagina
  // const listElements = document.querySelectorAll('li');
  // expect(listElements.length).toBe(mock_fields.querystring.b_size);
