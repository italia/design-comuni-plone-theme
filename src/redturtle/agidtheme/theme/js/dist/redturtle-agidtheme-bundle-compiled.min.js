      ...
      function(e, t, n) {
        ...
        function ae(e) {
          var t = e.icons,
            ...
            g = [P.replacementClass, a ? P.familyPrefix + '-' + a : '', h]
              .concat(l.classes)
              .join(' '),
            v = {
              children: [],
        ...
        var ce = function() {},
          se =
            P.measurePerformance && p && p.mark && p.measure
              ? p
              : { mark: ce, measure: ce },
          le = 'FA "5.0.5"',
          fe = function(e) {
        ...
        var Ne = {
          replace: function(e) {
            ...
            if (t.parentNode && t.outerHTML)
              t.outerHTML =
                n +
                (P.keepOriginalSource && 'svg' !== t.tagName.toLowerCase()
                  ? '\x3c!-- ' + t.outerHTML + ' --\x3e'
                  : '');
          ...
          nest: function(e) {
            var t = e[0],
              n = e[1];
            if (~G(t).indexOf(P.replacementClass)) return Ne.replace(e);
            var r = new RegExp(P.familyPrefix + '-.*');
            delete n[0].attributes.style;
            var i = n[0].attributes.class.split(' ').reduce(
              function(e, t) {
                return (
                  t === P.replacementClass || t.match(r)
                    ? e.toSvg.push(t)
                    : e.toNode.push(t),
                  e
                );
          ...
          0 === e.length
            ...
            : (f.requestAnimationFrame ||
                ...
                var t =
                    !0 === P.autoReplaceSvg
                      ? Ne.replace
                      : Ne[P.autoReplaceSvg] || Ne.replace,
                  r = ue.begin('mutate');
                e.map(t), r(), n();
              });
        }
        ...
        var Te = function(e) {
          ...
          He = function(e) {
            return Se(e.getAttribute('data-fa-transform'));
          },
          Ee = function(e) {
        ...
        function Ye(e, t) {
          ...
          } else if (e && t && !P.showMissingIcons)
            throw new Ve(
        ...
        function Ue(e) {
          ...
          return ~w.extra.classes.indexOf(Xe)
            ? (function(e, t) {
                ...
                return (
                  P.autoA11y && !n && (i.attributes['aria-hidden'] = 'true'),
                  [
                    e,
                    oe({
                      content: e.innerHTML,
                ...
                var s = ue.begin('onTree'),
                  l = c.reduce(function(e, t) {
                    try {
                      ...
                      z || (e instanceof Ve && console.error(e));
                    }
                    return e;
                  }, []);
                s(),
        ...
        var at,
          ...
          ct = function() {
            var e;
            V({ autoReplaceSvg: (e = !1), observeMutations: e });
          },
          st = {
            i2svg: function() {
              var e =
              ...
              if (h) {
                ...
                P.searchPseudoElements && Ke(n), Je(n, i);
              }
            },
            css: Ze,
            insertCss: function() {
              ...
              return (
                ...
                oe({
                  ...
                  extra: {
                    attributes: l,
                    styles: u,
                    classes: [P.familyPrefix + '-layers-text'].concat(S(c)),
                  },
                })
              );
            });
            ...
            return rt({ type: 'layer' }, function() {
              ...
              return (
                ...
                [
                  {
                    tag: 'span',
                    attributes: { class: P.familyPrefix + '-layers' },
                    children: t,
                  },
                ]
              );
          ...
          mt = function() {
            h && P.autoReplaceSvg && pt.dom.i2svg({ node: u });
          };
            ...
            (function(e) {
              ...
              m &&
                                ...
                                U(e).forEach(function(e) {
                                  if (
                                    ('childList' === e.type &&
                                      ...
                                      !Me(e.addedNodes[0]) &&
                                      (P.searchPseudoElements && r(e.target),
                                      t(e.target)),
                                    'attributes' === e.type &&
                                      e.target.parentNode &&
                ...
                (_.hooks = T({}, _.hooks, {
                  ...
                  addShims: function(e) {
                    var t;
                    (t = _.shims).push.apply(t, S(e)), be(), mt();
                  },
                }));
            });
        var ht = pt.config;
  ...
  require(['jquery', 'ellipsed', 'fa'], function(e, t, n) {
    ...
    e(document).ready(function() {
      ...
      e('.news-column').length
        ...
        e('button.plone-navbar-toggle').on('click', function(t) {
        ...
        e('.pat-tiles-management').on('rtTilesLoaded', function(e) {
          r('.tile-collection .collectionItemDescription', 4, {
            responsive: !0,
          }),
