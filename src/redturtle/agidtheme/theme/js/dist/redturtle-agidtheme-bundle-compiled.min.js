  ...
  function o(e, o) {
    ...
    return (
      (n.textContent = n.textContent.length
        ...
        : '' + o + i.replaceStr),
      parseFloat(a.height) > parseFloat(r) && (p++, (d = a.height), p === l + 1)
        ? ((n.innerHTML =
  ...
  (e.disableResponsive = function(e) {
    ...
    (e.ellipsis = function e() {
      ...
      if (l.responsive) {
        var g = !1,
          u = function() {
            for (var o = 0; o < s.length; o++) s[o].textContent = i[o];
            e(n, a, t({}, r, { responsive: !1 }));
          },
          h = function() {
            clearTimeout(g), (g = setTimeout(u, l.debounceDelay));
          };
    ...
    e(document).ready(function() {
      ...
      if (
        ...
        e('button.plone-navbar-toggle').on('click', function() {
          e('#portal-mainnavigation').toggleClass('open');
        }),
        e('#globalnav-close').click(function() {
          e('#portal-mainnavigation').removeClass('open');
        }),
        e(document).on('click', function(o) {
          !e(o.target).closest('#portal-searchbox').length &&
            ...
            !e(o.target).closest('#portal-globalnav-wrapper').length &&
              ...
              e(window).width() <= 991 &&
              e('#portal-mainnavigation #portal-globalnav').length &&
              e('#portal-mainnavigation #portal-globalnav').hasClass(
                'plone-nav'
              ) &&
              e('#portal-mainnavigation').removeClass('open');
        }),
