    ...
    (e.ellipsis = function e() {
      ...
      if (o.responsive) {
        var m = !1,
          ...
          h = function() {
            clearTimeout(m), (m = setTimeout(p, o.debounceDelay));
          };
  ...
  define('fa', [], function() {
    return (function(e) {
      ...
      function(e, t, n) {
        ...
        var ee = { x: 0, y: 0, width: '100%', height: '100%' },
          te = function(e) {
            var t = e.children,
              ...
              m = { tag: 'g', attributes: T({}, f.outer), children: [d] },
              p = 'mask-' + Y(),
              h = 'clip-' + Y(),
              g = {
                tag: 'defs',
        ...
        var ce = function() {},
          se =
            P.measurePerformance && m && m.mark && m.measure
              ? m
              : { mark: ce, measure: ce },
          le = 'FA "5.0.5"',
          fe = function(e) {
          ...
          return ~w.extra.classes.indexOf(Xe)
            ...
            : ((u = e),
              ...
              [
                u,
                ae({
                  icons: { main: Ye(m, h), mask: Ye(x.iconName, x.prefix) },
                  prefix: h,
                  iconName: m,
                  transform: v,
                  symbol: b,
        ...
        var at,
          ...
          pt = function() {
            h && P.autoReplaceSvg && mt.dom.i2svg({ node: u });
          };
        Object.defineProperty(mt, 'config', {
          ...
          h &&
            (function(e) {
              ...
              p &&
                (f.FontAwesome || (f.FontAwesome = mt),
                B(function() {
                  Object.keys(_.styles).length > 0 && pt(),
                    P.observeMutations &&
                ...
                (_.hooks = T({}, _.hooks, {
                  addPack: function(e, t) {
                    (_.styles[e] = T({}, _.styles[e] || {}, t)), be(), pt();
                  },
                  addShims: function(e) {
                    var t;
                    (t = _.shims).push.apply(t, S(e)), be(), pt();
                  },
                }));
            });
        var ht = mt.config;
