  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      var f = (r.navigator || {}).userAgent,
        ...
        v = ~s.indexOf('MSIE') || ~s.indexOf('Trident/'),
      ...
      var tt = { x: 0, y: 0, width: '100%', height: '100%' },
        et = function(t) {
          var e = t.children,
            ...
            u = { tag: 'rect', attributes: O({}, tt, { fill: 'white' }) },
            m = {
              tag: 'g',
              ...
              children: [
                {
                  tag: 'path',
                  attributes: O({}, c.attributes, l.path, { fill: 'black' }),
                },
              ],
            },
            d = { tag: 'g', attributes: O({}, l.outer), children: [m] },
            h = 'mask-' + q(),
            p = 'clip-' + q(),
            v = {
              tag: 'defs',
      ...
      function at(t) {
        var e = t.icons,
          ...
          v = [P.replacementClass, a ? P.familyPrefix + '-' + a : '', p]
            .concat(s.classes)
            .join(' '),
          g = {
            children: [],
        ...
        u && (g.attributes[y] = ''),
          f &&
            g.children.push({
              tag: 'title',
              attributes: {
                id: g.attributes['aria-labelledby'] || 'title-' + q(),
              },
              children: [f],
            });
        var b = O({}, g, {
          ...
          x = i.found && n.found ? et(b) : nt(b),
          w = x.children,
          z = x.attributes;
        return (b.children = w), (b.attributes = z), c ? rt(b) : it(b);
      }
      function ot(t) {
        var e = t.content,
          n = t.width,
        ...
        var k = Q(z);
        k.length > 0 && (s.style = k);
        var M = [];
        return (
          M.push({ tag: 'span', attributes: s, children: [e] }),
          a &&
            M.push({
              tag: 'span',
      ...
      function wt(t) {
        return t.reduce(function(t, e) {
          var n = G(P.familyPrefix, e);
          if (xt[e]) t.prefix = e;
          else if (n) {
            var i =
              'fa' === t.prefix
                ? gt[n] || { prefix: null, iconName: null }
                : {};
      ...
      var Ct = {
        replace: function(t) {
          ...
          if (e.parentNode && e.outerHTML)
            e.outerHTML =
              n +
              (P.keepOriginalSource && 'svg' !== e.tagName.toLowerCase()
                ? '\x3c!-- ' + e.outerHTML + ' --\x3e'
                : '');
      ...
      var Ot = function(t) {
          ...
          return (
            ...
            f.prefix && c.length > 1
              ? (f.iconName = ((i = f.prefix), (r = t.innerText), vt[i][r]))
              : f.prefix &&
                1 === c.length &&
        ...
        Et = function(t) {
          return Vt(t.getAttribute('data-fa-transform'));
        },
        jt = function(t) {
        ...
        St = function(t) {
          ...
          return (
            P.autoA11y &&
              (n
                ? (e['aria-labelledby'] = P.replacementClass + '-title-' + q())
                : (e['aria-hidden'] = 'true')),
            e
          );
        },
      ...
      var It = { fill: 'currentColor' },
        ...
        Xt = {
          ...
          children: [
            ...
            {
              tag: 'circle',
              attributes: O({}, It, { cx: '256', cy: '364', r: '28' }),
              children: [
                {
                  tag: 'animate',
                  attributes: O({}, _t, {
                ...
                {
                  tag: 'animate',
                  attributes: O({}, Bt, { values: '1;0;1;1;0;1;' }),
                },
              ],
            },
            {
              ...
              children: [
                {
                  tag: 'animate',
                  attributes: O({}, Bt, { values: '1;0;0;0;0;1;' }),
                },
              ],
            },
            {
              ...
              children: [
                {
                  tag: 'animate',
                  attributes: O({}, Bt, { values: '0;0;1;1;0;0;' }),
                },
              ],
            },
          ],
      ...
      function qt(t, e) {
        var n = { found: !1, width: 512, height: 512, icon: Xt };
        if (t && e && Rt[e] && Rt[e][t]) {
          var i = Rt[e][t];
          n = {
            found: !0,
        ...
        } else if (t && e && !P.showMissingIcons)
          throw new Tt(
      ...
      function Ut(t) {
        ...
        return ~w.extra.classes.indexOf(Ft)
          ? (function(t, e) {
              ...
              return (
                P.autoA11y && !n && (r.attributes['aria-hidden'] = 'true'),
                [
                  t,
                  ot({
                    content: t.innerHTML,
      ...
      function Gt(t) {
        if (p) {
          var e = ut.begin('searchPseudoElements');
          (At = !0),
            (function() {
              U(t.querySelectorAll('*')).forEach(function(t) {
                [':before', ':after'].forEach(function(e) {
                  var n = l.getComputedStyle(t, e),
                    i = n.getPropertyValue('font-family').match(Wt),
              ...
              var f = ut.begin('onTree'),
                s = c.reduce(function(t, e) {
                  try {
                    ...
                    k || (t instanceof Tt && console.error(t));
                  }
                  return t;
                }, []);
              f(),
          ...
          H(t, [
            {
              ...
              value: function() {
                for (
                  var t = this, e = arguments.length, n = Array(e), i = 0;
                  i < e;
                  i++
                )
                  n[i] = arguments[i];
                ...
                Object.keys(r).forEach(function(e) {
                  (t.definitions[e] = O({}, t.definitions[e] || {}, r[e])),
                    (function t(e, n) {
                      var i = Object.keys(n).reduce(function(t, e) {
                        var i = n[e];
                        return (
                          i.icon ? (t[i.iconName] = i.icon) : (t[e] = i), t
                        );
                      }, {});
                      'function' == typeof _.hooks.addPack
                        ? _.hooks.addPack(e, i)
                        : (_.styles[e] = O({}, _.styles[e] || {}, i)),
                        'fas' === e && t('fa', n);
                    })(e, r[e]);
                });
              },
      ...
      function re(t) {
        var e = t.prefix,
          n = void 0 === e ? 'fa' : e,
          i = t.iconName;
        if (i) return zt(oe.definitions, n, i) || zt(_.styles, n, i);
      }
      var ae,
        oe = new $t(),
        ce = function() {
        ...
        fe = {
          i2svg: function() {
            ...
            if (p) {
              ...
              P.searchPseudoElements && Gt(n), Jt(n, r);
            }
          },
          css: Zt,
          insertCss: function() {
        ...
        le = ((ae = function(t) {
          ...
          if (t) {
            var v = t.prefix,
              g = t.iconName,
              b = t.icon;
            return ie(O({ type: 'icon' }, t), function() {
              return (
                ne(),
                P.autoA11y &&
                  (s
            ...
            return (
              ...
              ot({
                ...
                extra: {
                  attributes: s,
                  styles: u,
                  classes: [P.familyPrefix + '-layers-text'].concat(V(c)),
                },
              })
            );
          });
        ...
        he = function() {
          p && P.autoReplaceSvg && de.dom.i2svg({ node: u });
        };
      Object.defineProperty(de, 'config', {
        get: function() {
          return P;
        },
        set: function(t) {
        ...
        p &&
          (function(t) {
            ...
            h &&
              (l.FontAwesome || (l.FontAwesome = de),
              X(function() {
                Object.keys(_.styles).length > 0 && he(),
                  P.observeMutations &&
              ...
              (_.hooks = O({}, _.hooks, {
                addPack: function(t, e) {
                  (_.styles[t] = O({}, _.styles[t] || {}, e)), bt(), he();
                },
                addShims: function(t) {
                  var e;
                  (e = _.shims).push.apply(e, V(t)), bt(), he();
                },
              }));
          });
      var pe = de.config;
